  ...
  de: [
    {
      ...
      images: [
        { src: "/images/hero-bed.jpg", alt: "Bett und Schlafbereich" },
        { src: "/images/table-wardrobe.jpg", alt: "Tisch und offener Kasten" },
      ],
    },
    {
      title: "Küche & Wohnen",
      images: [
        { src: "/images/entry-kitchen.jpg", alt: "Eingangsbereich und Küche" },
        { src: "/images/kitchen-line.jpg", alt: "Küchenzeile" },
        { src: "/images/fridge-dishwasher.jpg", alt: "Kühlschrank und Geschirrspüler" },
      ],
    },
    {
      title: "Bad & Komfort",
      images: [
        { src: "/images/bathroom-shower.jpg", alt: "Badezimmer mit Dusche" },
        { src: "/images/sink-toilet.jpg", alt: "Waschbecken und Toilette" },
        { src: "/images/sink-towelwarmer.jpg", alt: "Waschbecken und Handtuchwärmer" },
      ],
    },
  ],
  en: [
    {
      title: "Sleep & unwind",
      images: [
        { src: "/images/hero-bed.jpg", alt: "Bed and sleeping area" },
        { src: "/images/table-wardrobe.jpg", alt: "Table and open wardrobe" },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        { src: "/images/bathroom-shower.jpg", alt: "Bathroom with shower" },
...
function Gallery({ lang, onOpen }) {
  const groups = galleryData[lang];
  let runningIndex = 0;
...
function weekdayLabels(lang) {
  return lang === "de" ? ["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"] : ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
}
...
export default function App() {
  ...
  const t = useMemo(() => ({
    de: {
      nav: { stay: "Studio", gallery: "Fotos", features: "Ausstattung", location: "Lage", pricing: "Preise", availability: "Verfügbarkeit", contact: "Kontakt", legal: "Rechtliches" },
      hero: {
        ...
        highlights: ["ab 65 € / Nacht", "Clever geplante 22 m²", "5 Gehminuten ins Zentrum", "starke Lage für Aktivurlaub", "Gratis Parkplatz", "Self Check-in jederzeit"],
      ...
      features: {
        ...
        groups: [
          { title: "Studio & Komfort", items: ["Doppelbett", "Tisch und offener Kleiderschrank", "Ruhiger, durchdachter Grundriss", "Ideal für Paare und aktive Reisende"] },
      ...
      legal: {
        title: "Impressum",
        intro: "Angaben gemäß § 5 ECG / Offenlegung gemäß Mediengesetz.",
        mediaOwner: "Medieninhaber und für den Inhalt verantwortlich",
        purposeTitle: "Unternehmensgegenstand / Zweck der Website",
        purposeText: "Information über die Ferienunterkunft „Modern Studio Perauer“ sowie Möglichkeit zur direkten Kontaktaufnahme und Buchungsanfrage.",
        lineTitle: "Grundlegende Richtung der Website (Blattlinie)",
        lineText: "Diese Website dient der Präsentation der Ferienunterkunft „Modern Studio Perauer“ sowie der Information von Interessenten und Gästen.",
        privacyTitle: "Datenschutz",
        privacyIntro: "Der Schutz Ihrer persönlichen Daten ist uns wichtig. Wir verarbeiten Ihre Daten ausschließlich im Rahmen der gesetzlichen Bestimmungen.",
        privacyPoints: [
          "Verantwortlicher: Paul Perauer, Waschanger 33, 9853 Gmünd in Kärnten, Österreich",
          "Beim Besuch der Website werden technische Zugriffsdaten durch den Hosting-Anbieter verarbeitet.",
          "Wenn Sie per E-Mail, Telefon oder WhatsApp Kontakt aufnehmen, werden Ihre Angaben zur Bearbeitung Ihrer Anfrage verarbeitet.",
          "Externe Dienste bzw. Links können insbesondere Google Maps, WhatsApp, Airbnb und Booking.com betreffen.",
          "Der Verfügbarkeitskalender verarbeitet technische Daten zur Anzeige und Aktualisierung freier bzw. belegter Tage.",
    ...
    en: {
      ...
      hero: {
        ...
        highlights: ["from €65 / night", "Smartly designed 22 m²", "5 minutes to town centre", "great base for active stays", "free parking", "self check-in anytime"],
      ...
      features: {
        ...
        groups: [
          { title: "Studio & comfort", items: ["Double bed", "Table and open wardrobe", "Quiet and well-planned layout", "Ideal for couples and active travellers"] },
      ...
      legal: {
        title: "Imprint",
        intro: "Information according to Austrian e-commerce and media law.",
        mediaOwner: "Media owner and responsible for content",
        purposeTitle: "Purpose of the website",
        purposeText: "Information about the holiday apartment “Modern Studio Perauer” and the possibility of direct contact and booking inquiries.",
        lineTitle: "Editorial policy",
        lineText: "This website presents the holiday apartment “Modern Studio Perauer” and provides information for interested guests.",
        privacyTitle: "Privacy policy",
        privacyIntro: "Protecting your personal data is important. Data is processed only within the framework of applicable legal provisions.",
        privacyPoints: [
          "Controller: Paul Perauer, Waschanger 33, 9853 Gmünd in Carinthia, Austria",
          "Technical access data may be processed by the hosting provider when this website is visited.",
          "If you contact us by email, phone or WhatsApp, your details are processed to handle your inquiry.",
          "External services or links may include Google Maps, WhatsApp, Airbnb and Booking.com.",
          "The availability calendar processes technical data needed to display and refresh free and booked dates.",
  ...
  const c = t[lang];
  const allImages = useMemo(() => galleryData[lang].flatMap((group) => group.images), [lang]);
    ...
    <div className="site-shell">
      <header className="topbar">
        <div className="container topbar-inner">
          ...
          <nav className="nav">
            <a href="#studio">{c.nav.stay}</a>
            <a href="#gallery">{c.nav.gallery}</a>
            <a href="#features">{c.nav.features}</a>
            <a href="#location">{c.nav.location}</a>
            <a href="#pricing">{c.nav.pricing}</a>
            <a href="#availability">{c.nav.availability}</a>
            <a href="#contact">{c.nav.contact}</a>
            <a href="#legal">{c.nav.legal}</a>
          </nav>
          <button className="lang-toggle" type="button" onClick={() => setLang(lang === "de" ? "en" : "de")}>
            <Globe size={16} />
      ...
      <main>
        <section className="hero container">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="badge"><Sparkles size={16} /> {c.hero.badge}</div>
            <h1>{c.hero.title}</h1>
            <p className="hero-copy">{c.hero.subtitle}</p>
            <div className="cta-row">
              <Button href="#contact">{c.hero.primaryCta} <ChevronRight size={16} /></Button>
              <Button href="#gallery" outline>{c.hero.secondaryCta}</Button>
            </div>
            <div className="highlight-grid">
              {c.hero.highlights.map((item) => <div className="highlight" key={item}>{item}</div>)}
            </div>
          </motion.div>
          ...
          <motion.div className="hero-image-wrap" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }}>
            ...
            <div className="hero-overlay-card">
              ...
              <div className="overlay-copy">{c.hero.overlayCopy}</div>
            </div>
          </motion.div>
        </section>

        <section id="studio" className="container section">
          <SectionTitle eyebrow={c.value.eyebrow} title={c.value.title} text={c.value.intro} />
        ...
        <section className="container section section-tight">
          <div className="icon-grid">
            <Card className="icon-card"><UtensilsCrossed size={22} /><strong>{c.icons.kitchen}</strong></Card>
            <Card className="icon-card"><Wifi size={22} /><strong>{c.icons.wifi}</strong></Card>
            <Card className="icon-card"><BedDouble size={22} /><strong>{c.icons.bed}</strong></Card>
            <Card className="icon-card"><ShowerHead size={22} /><strong>{c.icons.shower}</strong></Card>
            <Card className="icon-card"><Monitor size={22} /><strong>{c.icons.work}</strong></Card>
            <Card className="icon-card"><WashingMachine size={22} /><strong>{c.icons.wash}</strong></Card>
          </div>
        </section>
        ...
        <section className="container section">
          <div className="grid-2-wide">
            <Card>
              <div className="inline-head"><Home size={18} /><h3>{c.facts.title}</h3></div>
            ...
            <Card className="soft-card audience-card">
              <div className="small-kicker">{c.audience.title}</div>
              <div className="chip-wrap">
                {c.audience.items.map((item) => <span className="chip" key={item}>{item}</span>)}
              </div>
            </Card>
          </div>
        </section>
        ...
        <section id="gallery" className="container section">
          <SectionTitle
            eyebrow={lang === "de" ? "Echte Fotos" : "Real photos"}
            title={lang === "de" ? "Einblicke ins Studio" : "Inside the studio"}
            text={lang === "de"
              ? "Die Bilder sind nach Bereichen gruppiert, damit man das Studio schnell erfassen kann. Ein Klick öffnet jedes Bild groß im Vollbildmodus."
              : "The photos are grouped by area so guests can understand the studio quickly. Clicking any image opens it large in fullscreen mode."}
          />
          <Gallery lang={lang} onOpen={setLightboxIndex} />
        </section>

        <section className="container section section-tight">
          <Card className="review-section-card">
            <SectionTitle eyebrow={lang === "de" ? "Vertrauen" : "Trust"} title={c.reviews.title} text={c.reviews.text} />
            <div className="review-stats-row">
              {c.reviews.stats.map((item) => <span className="chip review-chip" key={item}>{item}</span>)}
            </div>
            <div className="cta-row">
              <Button href="https://www.airbnb.at/rooms/715928217720024482" outline target="_blank" rel="noreferrer">{c.reviews.airbnb} <ExternalLink size={16} /></Button>
              <Button href="https://www.booking.com/hotel/at/modern-studio-rental-in-gmund-in-karnten.de.html" outline target="_blank" rel="noreferrer">{c.reviews.booking} <ExternalLink size={16} /></Button>
            </div>
          </Card>
        </section>

        <section id="features" className="container section">
          <SectionTitle eyebrow={lang === "de" ? "Ausstattung" : "Features"} title={c.features.title} />
          <div className="grid-3">
        ...
        <section id="location" className="container section">
          <div className="grid-2">
            <div>
              <SectionTitle eyebrow={lang === "de" ? "Umgebung" : "Around you"} title={c.location.title} text={c.location.text} />
              <div className="list">
                {c.location.points.map((point) => (
              ...
              <div className="cta-row">
                <Button href="https://maps.app.goo.gl/J5fKVc2VU9DzRR4v5" outline target="_blank" rel="noreferrer">{c.location.mapTitle} <ExternalLink size={16} /></Button>
              </div>
            </div>
        ...
        <section id="pricing" className="container section">
          <div className="grid-2-wide">
            <Card className="dark-card">
              <div className="inline-head"><Euro size={18} /><div className="small-kicker invert">{c.pricing.title}</div></div>
              <div className="price">{c.pricing.price}</div>
              <p className="invert-text">{c.pricing.note}</p>
            </Card>
            <div className="grid-2">
              <Card>
        ...
        <section id="availability" className="container section">
          <SectionTitle eyebrow={lang === "de" ? "Planung" : "Planning"} title={c.availability.title} text={c.availability.text} />
        ...
        <section id="contact" className="container section">
          <div className="grid-2">
            <div>
              <SectionTitle eyebrow={lang === "de" ? "Direkt buchen" : "Direct booking"} title={c.contact.title} text={c.contact.text} />
              <div className="contact-list">
                <div className="contact-item"><Phone size={18} /><div><div className="contact-label">{c.contact.phoneLabel}</div><a href="tel:+436707019210">{c.contact.phone}</a></div></div>
                <div className="contact-item"><Mail size={18} /><div><div className="contact-label">{c.contact.mailLabel}</div><a href="mailto:perauerappartments@gmail.com">{c.contact.mail}</a></div></div>
                <div className="contact-item"><MapPin size={18} /><div><div className="contact-label">{c.contact.addressLabel}</div><div>{c.contact.address}</div></div></div>
              </div>
            </div>
            <Card className="soft-card">
              ...
              <div className="cta-row">
                <Button href="mailto:perauerappartments@gmail.com">{c.contact.ctaMail}</Button>
                <Button href="tel:+436707019210" outline>{c.contact.ctaCall}</Button>
                <Button href={whatsappLink} outline target="_blank" rel="noreferrer"><MessageCircle size={16} /> {c.contact.ctaWhatsApp}</Button>
              </div>
            </Card>
          </div>
        </section>
        ...
        <section id="legal" className="container section">
          <SectionTitle eyebrow={lang === "de" ? "Rechtliches" : "Legal"} title={c.legal.title} text={c.legal.intro} />
          <div className="grid-2-wide">
            <Card>
              <div className="inline-head"><FileText size={18} /><h3>{c.legal.title}</h3></div>
              <div className="legal-block">
                <strong>{c.legal.mediaOwner}</strong><br />
                Paul Perauer<br />
                Waschanger 33<br />
                9853 Gmünd in Kärnten<br />
                Österreich<br /><br />
                Telefon: +43 670 7019210<br />
                E-Mail: perauerappartments@gmail.com<br /><br />
                <strong>{c.legal.purposeTitle}</strong><br />
                {c.legal.purposeText}<br /><br />
                <strong>{c.legal.lineTitle}</strong><br />
                {c.legal.lineText}
              </div>
            </Card>
            <Card>
              <div className="inline-head"><FileText size={18} /><h3>{c.legal.privacyTitle}</h3></div>
              <p>{c.legal.privacyIntro}</p>
              <div className="list legal-list">
                {c.legal.privacyPoints.map((point) => (
                  <div className="list-item" key={point}><Check size={16} /><span>{point}</span></div>
                ))}
              </div>
            </Card>
          </div>
      ...
      <Lightbox
        ...
        onPrev={() => setLightboxIndex((prev) => prev === null ? 0 : (prev - 1 + allImages.length) % allImages.length)}
        onNext={() => setLightboxIndex((prev) => prev === null ? 0 : (prev + 1) % allImages.length)}
      />

      <footer className="footer">
        <div className="container">
          <div className="footer-title">{c.footer.line1}</div>
          <div className="footer-copy">{c.footer.line2}</div>
        </div>
      </footer>
    </div>
  );
